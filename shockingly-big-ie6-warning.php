...
$opt = get_option('ie6w_options');
    ...
    <p><?php echo __('<a href="' . $plug_site . '">' . $plug_name . ' v' . $plug_ver . '</a> by <a href="mailto:matias@incerteza.org">matias s.</a> at <a href="http://www.incerteza.org/blog/" target="_blank" rel="nofollow">incerteza.org</a>', $ie6w_dom); ?></p>
	</div>
<?php }
?>